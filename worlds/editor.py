...
from stanfordkarel.karel_canvas import DEFAULT_ICON, LIGHT_GREY, PAD_X, PAD_Y, \
    KarelCanvas
...
class WorldBuilderApplication(tk.Frame):
    ...
    def create_new_world(self, init: bool = False,
    ...
    def create_buttons(self) -> None:
        ...
        self.program_control_button.grid(column = 0, row = 0, padx = PAD_X,
                                         pady = PAD_Y)

        self.load_world_button = tk.Button(
            self, highlightthickness = 0, text = "Load World",
            command = self.load_world
        )
        self.load_world_button.grid(column = 0, row = 1, padx = PAD_X,
                                    pady = PAD_Y)

        self.save_world_button = tk.Button(
            self, highlightthickness = 0, text = "Save World",
            command = self.save_world
        )
        self.save_world_button.grid(column = 0, row = 2, padx = PAD_X,
                                    pady = PAD_Y)
    ...
    def create_direction_radio_buttons(self) -> None:
        ...
        self.dir_radio_frame.grid(row = 3, column = 0, padx = PAD_X,
    ...
    def create_action_radio_buttons(self) -> None:
        ...
        action_label = tk.Label(self.action_radio_frame, text = "Action: ",
                                bg = LIGHT_GREY)
